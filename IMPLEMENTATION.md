...
4. **Email workflow (partially implemented):** `senpilot/reply.py` composes unsent MIME replies from supplied counts, checks attachment size, and handles empty or partial results. Receiving and sending real email remain to be implemented.
